...
I18N_KO = {
    ...
    # --- Demo presentation upgrade (Hero / 3-scenario / segment insights) ---
    "Today's headline": "오늘의 헤드라인",
    "invested →": "투자로 →",
    "customers precisely targeted": "명을 정밀 타겟팅",
    "won-for-won return": "예산 1원당 회수",
    "won per won": "원 회수",
    "Three scenarios side by side": "세 가지 시나리오 비교",
    "No intervention": "무대응",
    "Spray & pray (uniform)": "무차별 살포 (전원에게)",
    "AI targeting (ours)": "AI 타겟팅 (우리 시스템)",
    "Total CLV": "총 CLV",
    "Coupon spend": "쿠폰 비용",
    "Saved revenue": "회수 매출",
    "AI uses ": "AI는 무차별 대비 ",
    " less budget than uniform spray while delivering ": "배 적은 예산으로 ",
    " higher ROI.": " 높은 ROI를 달성합니다.",
    "AI uses **{ratio:.1f}x** less budget than uniform spray while delivering **{lift:+.0f}%** higher ROI.": "AI는 무차별 살포 대비 **{ratio:.1f}배** 적은 예산으로 **{lift:+.0f}%** 더 높은 ROI를 달성합니다.",
    "AI precisely picks <b>{selected}</b> out of <b>{total}</b> customers, delivering <b>{ratio:.1f}x</b> less spend than uniform spray and <b>{lift:+.0f}%</b> higher ROI.": "AI는 전체 <b>{total}</b>명 중 정확히 <b>{selected}</b>명을 골라, 무차별 살포 대비 <b>{ratio:.1f}배</b> 적은 예산으로 ROI를 <b>{lift:+.0f}%</b> 향상시킵니다.",
    "All three scenarios are evaluated at the same budget the slider is set to — drag it to see them all move together.": "세 시나리오 모두 슬라이더의 현재 예산을 기준으로 평가됩니다 — 드래그하면 동시에 갱신됩니다.",
    "At the same budget, AI generates **{extra}** more net gain than uniform spray (**{lift:+.0f}%** higher ROI).": "같은 예산에서 AI는 무차별 살포 대비 **{extra}** 더 많은 순이득을 만듭니다 (ROI **{lift:+.0f}%** 높음).",
    "Re-grouped at the current slider budget. Allocation shifts as you change the budget — the LP picks the next-best segment once a cheaper one fills up.": "현재 슬라이더 예산 기준으로 재집계됩니다. 예산을 바꾸면 배정도 함께 변합니다 — 저렴한 세그먼트가 차면 LP가 다음으로 우수한 세그먼트를 선택합니다.",
    "Show full segment allocation table at current budget": "현재 예산 기준 전체 세그먼트 배정 표 보기",
    "At a budget of <b>{budget}</b>, AI picks <b>{selected}</b> of <b>{total}</b> customers and delivers <b>{extra}</b> more net gain than uniform spray (<b>{lift:+.0f}%</b> higher ROI).": "예산 <b>{budget}</b>에서 AI는 전체 <b>{total}</b>명 중 <b>{selected}</b>명을 골라, 무차별 살포 대비 <b>{extra}</b> 더 많은 순이득을 만듭니다 (ROI <b>{lift:+.0f}%</b> 높음).",
    "Budget vs Net Gain (drag the slider above)": "예산 vs 순이득 (위 슬라이더를 드래그)",
    "Optimal budget": "최적 예산",
    "Optimal": "최적점",
    "Current": "현재",
    "net gain": "순이득",
    "Where AI concentrated the budget": "AI가 예산을 집중 투자한 곳",
    "Allocated": "배정",
    "Share of budget": "예산 비중",
    "Highest ROI segment: ": "최고 ROI 세그먼트: ",
    " spend, ": " 지출, ",
    "AI auto-excluded ": "AI가 자동 제외한 ",
    "customers (": "명의 고객 (",
    "treating them would either waste budget or hurt retention.": ") — 쿠폰을 줘도 효과가 없거나 오히려 유지율을 해침.",
    "Show full 8-segment allocation table": "전체 8개 세그먼트 배정 표 보기",
    "Conclusion": "결론",
    "AI precisely picks ": "AI는 정확히 ",
    "of ": "명 중 ",
    "customers, delivering ": "명만 골라, 무차별 살포 대비 ",
    "less spend than uniform spray and ": "배 적은 예산으로 ",
    "higher ROI.": "높은 ROI를 달성합니다.",
